...
def reply_bot():
    ...
    for comment in comment_stream:
        ...
        elif "!remove" in comment.body.lower() and comment.id not in hiatus_replied_to and comment.author in mods:
            mod_remove = comment.body.split()
            reply_body = ModTools.remove_alert(mod_remove[1], comment.submission.author)
